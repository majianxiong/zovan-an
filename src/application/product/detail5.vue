...
<div class='detail-content'>
  <div class='detail-header'>
    <img src='/static/pic/detail/header5.png'>
    <!-- <div class='header-info'>销量2488份</div> -->
  </div>
  <div class='detail-desc'>
    <p class='desc-title'>长城人寿康健人生终身重大疾病保险</p>
    <p class='desc-info'><span>100</span>种重大疾病+<span>50</span>种轻疾病+返本</p>
    <p class='desc-price'><span>830.00</span>￥起</p>
  </div>
  <div class='detail-split'>
    <span>重疾、轻症保障全</span>
    <span>轻症豁免保费</span>
    <span>祝寿金返还100%保费</span>
  </div>
  <group class="detail-group" label-width="4.5em" label-margin-right="2em" label-align="right">
    <cell title='保障计划' value='5万起' ></cell>
    <cell title='投保年龄' value='30天-60周岁' ></cell>
  ...
  const charactor = {
      ...
      'template' : `
        <div class='detail-charactor'>
          <img src='/static/pic/detail/content51.png'>
          <img src='/static/pic/detail/content52.png'>
        </div>
      `
  }
  const rule = {
    ...
    'template' : `
      <div class='detail-plan'>
        <img src='/static/pic/detail/content55.png'>
        <img src='/static/pic/detail/content56.png'>
      </div>
    `
  }
  const plan = {
    ...
    'template' : `
      <div class='detail-rule'>
        <img src='/static/pic/detail/content53.png'>
        <img src='/static/pic/detail/content54.png'>
      </div>
    `
  }
  ...
  export default {
    ...
    created(){
      ...
      if(wechatuserId != 'undefined')
        this.log({targetType:0,eventType:2,productCode:'ZA0002',userId:wechatuserId})

      window.detailShare5 = ()=>{
        window.shareLog5 = (res)=>{
          //res 1:分享成功 2:失败
          if(!!res){
            this.log({targetType:0,eventType:1,productCode:'ZA0002',userId:userId})
          }
        };
    ...
    methods: {
      ...
      footerLClick () {
        ...
        if(!isapp){
          this.$router.push("/convertPlan/ZA0002")
          return
        }
        if(token){
          if(userType==1){
